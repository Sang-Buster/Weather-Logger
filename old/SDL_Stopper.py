...
def stop_high_frequency_logging():
    ...
    try:
        ...
        print(
            "High-frequency (32 Hz) mode STOP command sent successfully to port", port
        )
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("3. The high-frequency log file should be closed\n")
        print("To switch back to 32 Hz mode, run SDL_Starter.py\n")
